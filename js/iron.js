...
$(document).ready(function(){
    ...
    /* Hide the brand text since it's the same text as the main logo. 
     * This way there isn't repeating elements on the screen
     * JavaScript is used instead just in case the browser the user has does not support javascript.
     * Then the logo will just appear twice instead of not at all
     */ 
    $('.brand').hide();
